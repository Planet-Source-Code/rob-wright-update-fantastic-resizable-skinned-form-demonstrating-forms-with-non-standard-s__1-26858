...
' Turn on Option Explicit - this forces you to
' explicitly declare all variables ... it's a
' pain in the butt but it's a good programming
' skill to have!
Option Explicit
...
' VERSION HISTORY:
' v2b - Dynamic colour scheme changing added to
'       the demo.
' v2a - Maximize/Restore button added.
' v2  - Now resizable at runtime, code commented
'       more, fixed a bug or two, form is now
'       maximized/restored by double-clicking the
'       titlebar, included some colour schemes in
'       the download.
' v1  - Original release.
...
Public Sub SetStateBtn(TheForm As Form, NewState As Long)
' ****************************************************
